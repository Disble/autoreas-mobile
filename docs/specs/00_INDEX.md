...
- **Spec:** Inicializar `npx create-expo-app@latest` con template TypeScript (`expo-router`). Configurar ESLint estricto para React Hooks. Instalar y linkear `expo-sqlite`, `drizzle-orm`, `zod`, `@tanstack/react-query`, `zustand`, `heroui-native`.
